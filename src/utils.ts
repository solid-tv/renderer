...
declare const __RTT__: boolean;
export const USE_RTT = typeof __RTT__ !== 'undefined' ? __RTT__ : true;

declare const __renderTextBatching__: boolean;
export const RENDER_TEXT_BATCHING =
  typeof __renderTextBatching__ !== 'undefined' ? __renderTextBatching__ : true;

declare const __enableAutosize__: boolean;
export const ENABLE_AUTOSIZE =
  typeof __enableAutosize__ !== 'undefined' ? __enableAutosize__ : false;

declare const __enableCompressedTextures__: boolean;
export const ENABLE_COMPRESSED_TEXTURES =
  typeof __enableCompressedTextures__ !== 'undefined'
    ? __enableCompressedTextures__
    : false;

declare const __calculateFps__: boolean;
export const CALCULATE_FPS =
  typeof __calculateFps__ !== 'undefined'
    ? __calculateFps__
...
export const DIRTY_QUAD_BUFFER =
  typeof __dirtyQuadBuffer__ !== 'undefined' ? __dirtyQuadBuffer__ : true;

declare const __emitBoundsEvents__: boolean;
export const EMIT_BOUNDS_EVENTS =
  typeof __emitBoundsEvents__ !== 'undefined' ? __emitBoundsEvents__ : false;
 ...
 */
export function premultiplyColorABGR(rgba: number, alpha: number): number {
  const a = ((rgba & 0xff) / 255) * alpha;
